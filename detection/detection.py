...
def detect_face(ctx, sym, arg_params, aux_params, img_nd, \
                nms_thresh=0.3, thresh=0.8):
    arg_params["data"] = img_nd
    im_info = mx.ndarray.array([[img_nd.shape[2], \
                                 img_nd.shape[3], \
                                 1]], ctx=ctx)
    arg_params["im_info"] = im_info
